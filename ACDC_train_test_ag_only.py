...
args.exp = 'MIST_CAM_AG_only_MUTATION_' + str(args.img_size)
snapshot_path = "{}/{}/{}".format(args.save_path, args.exp, 'MIST_CAM_AG_only_MUTATION')
...
def val():
    ...
    for i, val_sampled_batch in enumerate(valloader):
        ...
        per_class_dc = [
            dc(val_outputs == c, val_label_batch == c)
...
for epoch in tqdm(range(args.max_epochs)):
    ...
    for i_batch, sampled_batch in enumerate(train_loader):
        ...
        for s in ss:
            ...
            loss += (lc1 * loss_dice + lc2 * loss_ce)
